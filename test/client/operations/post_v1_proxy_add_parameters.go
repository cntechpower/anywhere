...
// WithZoneName adds the zoneName to the post v1 proxy add params
func (o *PostV1ProxyAddParams) WithZoneName(zoneName string) *PostV1ProxyAddParams {
	o.SetZoneName(zoneName)
	return o
}

// SetZoneName adds the zoneName to the post v1 proxy add params
func (o *PostV1ProxyAddParams) SetZoneName(zoneName string) {
	o.ZoneName = zoneName
}
